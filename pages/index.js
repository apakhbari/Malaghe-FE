...
function Home() {
  ...
  return (
    <Fragment>
      <Head>
        <title>{CLIENT_NAME_FA} - صفحه اصلی</title>
      </Head>
        ...
        */}
          ...
          */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black">
              <div className="bg-base-200 rounded-xl shadow-2xl  flex flex-col justify-between">
                <div className="p-8" dir="rtl">
                  ...
                  <p className="text-base-content text-xl text-center">
                    تیم پشتیبانی مرکز خدمات در کوتاه ترین زمان ممکن سوالات
                    مشتریان گرامی را پاسخ می دهد.
                  </p>
                </div>
              ...
              <div className="bg-base-200 rounded-xl shadow-2xl  flex flex-col justify-between">
                <div className="p-8" dir="rtl">
                  ...
                  <p className="text-base-content text-xl text-center">
                    با گسترش بستر اینترنت در ایران شکل گیری تجارت
                    الکترونیک،مدیران مرکز خدمات کراچیان اقدام به راه اندازی مرکز
                    خدمات آنلاین نموده اند که از نخستین مراکز تعمیرات تخصصی
                    لوازم برقی آشپزخانه بوده است.
                  </p>
                </div>
                <div className="bg-base-300 pl-8] py-4">
                  <p
              ...
              <div className="bg-base-200 rounded-xl shadow-2xl flex flex-col justify-between">
                <div className="p-8" dir="rtl">
                  ...
                  <p className="text-base-content text-xl text-center">
                    مرکز خدمات کراچیان فعالیت خود را از سال ۱۳۶۰ در زمینه
                    تعمیرات و خدمات پس از فروش لوازم خانگی برقی آشپزخانه آغاز
                    نموده است.
                  </p>
                </div>
                <div className="bg-base-300 pl-8 py-4 ">
