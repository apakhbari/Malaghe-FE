...
const Footer = () => {
  return (
    <footer className="footer p-10 bg-neutral text-neutral-content justify-around items-center">
      <div className="w-full justify-center text-center">
        <span className="footer-title w-full justify-center text-center ">
          ما
        </span>
        <Link
          href="/about-us"
      ...
      <div
        className="flex flex-col justify-center text-center place-content-center justify-items-center"
        dir="rtl"
      >
        <svg
          width="50"
          ...
          fill-rule="evenodd"
          clip-rule="evenodd"
          className="fill-current w-full justify-center text-center"
        >
